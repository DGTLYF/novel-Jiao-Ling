...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.pixiv.net/users/29139429', // 网站地址
  ...
  CONTACT_PIXIV: process.env.NEXT_PUBLIC_CONTACT_PIXIV || 'https://www.pixiv.net/users/29139429', // Pixiv主页
